...
import com.challenge.domain.dojo.events.AddedRule;
...
class AddNewMemberToClanUseCaseTest extends UseCaseHandleBaseTest{
    @Test
    void addNewMemberToClanUseCaseTest_happyPath() {
        ...
        Assertions.assertEquals("1001359866", addedMember.getCedula().value());
